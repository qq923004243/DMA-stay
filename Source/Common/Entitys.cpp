...
std::unordered_map<std::string, EntityInfo, FnvHash> EntityItemLists = {
    ...
    //枪口
    { "Item_Attach_Weapon_Muzzle_AR_MuzzleBrake_C", {"步枪制动 (步枪)", EntityType::Item, 0, WeaponType::Muzzle} },
...
std::unordered_map<std::string, EntityInfo, FnvHash> EntityVehicleLists = {
    ...
    {"BP_Blanc_C", {"布朗（白SUV）", EntityType::Vehicle, 0}},
    {"BP_Blanc_Esports_C", {"布朗（黑SUV）", EntityType::Vehicle, 0}},
